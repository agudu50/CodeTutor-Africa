          ...
          <div className="flex items-start sm:items-center gap-4 sm:gap-5 min-w-0 flex-1">
            ...
            <div className="space-y-1.5 min-w-0 flex-1">
              ...
              <div className="flex flex-wrap items-center gap-2 pt-1">
                ...
                {/* Offline AI Model Status Pill */}
                <span className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-emerald-50/80 dark:bg-emerald-950/60 border border-emerald-200/80 dark:border-emerald-800/80 text-xs font-semibold text-emerald-800 dark:text-emerald-300 shadow-3xs">
